...
from withings_api import WithingsSleepSummarySeries


class TestWithingsSleepSummarySeries(unittest.TestCase):
    def test_attributes(self):
        ...
        series = WithingsSleepSummarySeries(data)
        self.assertEqual(type(series), WithingsSleepSummarySeries)
